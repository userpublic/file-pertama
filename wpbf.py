...
if len(sys.argv) <= 1:
    ...
    print 'FRMFOX CODE'
    print 'MAMPIR GAN : https://frmfox.blogspot.com'
    print ''
    print 'Syntax: python wpbf-py [-u USER|-U FILE] [-p PASS|-P FILE] -h URL [OPT]'
    print ''
    print 'Options:'
    print '-h URL'
...
print 'WePe BeEf :v'
print 'FRMFOX CODE'
print 'Contact Mail : dr.frmfox@gmail.com'
...
try:
    ...
    #Finish
    print ''       
    print 'target beres gan, hasil, '+ str(countAcc) +' valid username+password found'
    print 'TARGER: ' + url
    print 'RESULT:'        
    print result
    sys.exit()
